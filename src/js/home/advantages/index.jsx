        ...
        return (
        	<div id="advantages" className="full-screen">
						<div className="col-xs-12 col-sm-10 col-sm-offset-1">
							<p className="advantage-explanation"><br/><span className="advantage-name">Location </span>
							...
							<p className="advantage-explanation"><span className="advantage-name">Design </span>
							...
							<p className="advantage-explanation"><span className="advantage-name">Opportunity </span>
							...
							<p className="advantage-explanation"><span className="advantage-name">Quality </span>
							...
							<p className="advantage-explanation"><span className="advantage-name">Flexibility </span>
